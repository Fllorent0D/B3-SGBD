/*    TO DO     */
-- Certifications et status (major) - DONE
-- Sanitize artists/genres (major) - DONE
-- Télécharger les posters (major) - DONE
-- Nettoyer /n/r début/fin de titre (major) - DONE
-- Mettre ... quand on truncate
-- Sanitize vote average ne fonctionne pas - FIXED
-- Rollback + log lors d'erreurs diverse (major) - FIXED
-- Refaire les Logs, avoir la meme structure pour tous les logs - DONE
-- REFACTO (mineur) - PARTIAL
-- Refaire les commentaires - DONE
-- Utiliser des NOCOPY (optimisation)? - DONE 
-- Avertissement si le tableau donné en param a des numeros qui n'existent pas  - DONE

-- **** BONUS COOL A FAIRE SI ON A DU TEMPS A PERDRE ****
-- Une procédure pour avoir tous les genres que en français et pas en anglais et francais - PARTIAL
